...
const fallbackEvents: EventItem[] = [
  ...
  },
  {
    ...
    description_ua: [
      ...
      "Учасники можуть спробувати прості арт-практики, подивитися на свій стан через колір, фактуру й форму, а також побачити, як творчість допомагає м'яко говорити про важливе.",
      "Цей додатковий текст потрібен для тимчасової заглушки, щоб на сторінці було видно розташування абзаців, галереї та кнопок до моменту появи реальних подій у базі.",
    ...
    description_en: [
      ...
      "Participants can try simple art practices, look at their current state through color, texture, and form, and see how creativity can gently open space for important conversations.",
      "This extra copy is part of the temporary placeholder, so the page shows the layout of paragraphs, gallery images, and controls until real events are added to the database.",
    ...
    galleryImages: [
      fallbackEventImages["art-workshop"],
      "/workshop3.png",
      "/workshop4.jpg",
      "/workshop5.jpg",
      "/workshop6.jpg",
