...
export function Home() {
  ...
  return (
    <>
      <section className="mx-auto flex w-full max-w-7xl flex-col px-4 sm:px-10 min-[1420px]:px-0 min-[1900px]:max-w-450">
        <article
            ...
            <article
              ...
              <img
                ...
                className="h-60 w-full rounded-[20px] object-cover
                 ...
                 min-[1420px]:self-start min-[1900px]:h-120!  min-[1900px]:object-cover"
              />
              <div
      ...
      <section
        ...
        flex-col items-center justify-center px-4 sm:px-10 min-[1420px]:px-0
        min-[1900px]:max-w-450">
        <h1
