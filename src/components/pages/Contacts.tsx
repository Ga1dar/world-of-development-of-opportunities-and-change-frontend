...
export function Contacts() {
  ...
  return (
    <section className="bg-secondary px-5 pb-12 pt-0 font-montserrat text-[#1C100E] sm:px-10 sm:pb-16 min-[1420px]:px-20 min-[1420px]:pb-15 min-[1420px]:pt-0 min-[1900px]:pb-17">
